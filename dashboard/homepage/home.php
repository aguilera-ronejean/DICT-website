...
<head>
	...
	<link rel="stylesheet" href="css/uactivities2.css">
...
<body>
	<section class="header">
		<nav>
			<a href="home.php"><img src="images/DICT.png"></a>
				...
				<ul>
					...
					<li><a href="#">ACCOUNT</a>
						<ul>
							...
							<li><a href="../../profile/mainprofile.php">PROFILE</a></li>
...
<section class="uactivities ">
	...
	<div class="row">
		...
		<form action = "dashboard/ReadEvent.php" method = "get">
		...
		<div class="activities-col">
		<form action = "dashboard/ReadEvent2.php" method = "get">
		...
		<div class="activities-col">
		<form action = "dashboard/ReadEvent3.php" method = "get">
...
<section class="tactivities ">
	...
	<div class="row align-items-center mt-2">
			...
			<?php 
			 ...
			 <footer>
		<div class="container">
			<img src="govph-seal-mono-footer.png" alt ="govph-seal-mono" class = "img1"/>
			<div class="ftr">
