...
<html>
    <?php include 'header/headerEdit.html';?>
    <style>
    <?php include 'header/headerEdit.css';?> 
    <?php include 'header/mobile1.css';?> 
    </style>


    <link rel = "stylesheet" href = 'AddEvent2.css'>
    <form class="form1" action = "UpdateEvent.php" method = "post">
        ...
        <input type = 'text' name = "updateProjectProgram" class = "proj" value = "<?php echo $projectACS?>" readonly onclick="this.blur">
