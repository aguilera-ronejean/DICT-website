...
<html>
    <?php include 'header/headerCreate.html';?>
    <style>
    <?php include 'header/headerCreate1.css';?> 
    ...
    <form class="form1" action = "" method = "post">
        ...
        <input tpye = "text" name = "project" class = "proj" value = "<?php echo $projectACS?>" readonly onfocus="this.blur();">
