...
<html>
    ...
    <div class = "tables">
    <?php while($row2 = mysqli_fetch_assoc($result_event)){?>
    <h3>
        <?php 
			$month = $row2['Month'];
    ...
    <form action = "EventCon.php" method = "post" enctype="multipart/form-data">
        <div class = 'hide_buttons'>
            ...
            <p>PICTURE:<input type = 'file' name = 'image' required></p>
            <input type = 'hidden' name = 'updateId' value = "<?php echo $editId?>">
            <input type = 'submit' name = 'submit' value = 'Submit' class="bttn">
        </div>
        
            <a href="../../homepage.php"><input type="button" class = "bttn" value="Cancel"></a>
