...
if(isset($_GET['edit'])){
        ...
        $id = $_GET['edit'];
        $sql2 = "SELECT * FROM accomplishment WHERE id = '$id' AND province = '$provinceACS' AND region = '$regionACS'";
}
else{
        $sql2 = "SELECT * FROM accomplishment WHERE province = '$provinceACS' AND region = '$regionACS'";
}

if(isset($_POST['view'])){
        $region = $_POST['regionACS'];
        $province = $_POST['provinceACS'];
...
<br><br><br>
        <center><button onclick = "window.location.href = 'acc_User.php';" id = "back-btn" class="btn btn-secondary" > Back</button>
        ...
        <tbody>
                ...
                <?php include 'headerAccUser/footer.html';?>
            <style>
                <?php include 'headerAccUser/footer1.css';?> 
            </style>
