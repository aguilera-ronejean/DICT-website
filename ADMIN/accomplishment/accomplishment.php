...
if (isset($_GET['edit'])) {     // puts selected row into textbox for it to be editted/deleted
    ...
    $sql2 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id'";
    ...
    $resourse_Person = $row['resourse_Person'];
    $male = $row['male'];
    $female = $row['female'];
    $senior_Male = $row['senior_Male'];
    $senior_Female = $row['senior_Female'];
    $pwd_Male = $row['pwd_Male'];
    $pwd_Female = $row['pwd_Female'];
    $conducted_By = $row['conducted_By'];
    $remarks = $row['remarks'];
    $resourse_Person = $row['resourse_Person'];
    $senior_Male = $row['senior_Male'];
    ...
    //where id = 1 AND PROVINCE  AND REGION

    $sql3 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region IV-B' AND province = 'Oriental Mindoro'";
    $result3 = mysqli_query($conn, $sql3) or die( mysqli_error($conn));
    $row3 = mysqli_fetch_array($result3);
        $male_R4B_ORM = $row3['male'];
        $female_R4B_ORM = $row3['female'];
    
    $sql4 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region IV-B' AND province = 'Occidental Mindoro'";
    $result4 = mysqli_query($conn, $sql4) or die( mysqli_error($conn));
    $row4 = mysqli_fetch_array($result4);
        $male_R4B_OCM = $row4['male'];
        $female_R4B_OCM = $row4['female'];
    
    $sql5 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region IV-B' AND province = 'Marinduque'";
    $result5 = mysqli_query($conn, $sql5) or die( mysqli_error($conn));
    $row5 = mysqli_fetch_array($result5);
        $male_R4B_MAR = $row5['male'];
        $female_R4B_MAR = $row5['female'];

    $sql6 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region IV-B' AND province = 'Romblon'";
    $result6 = mysqli_query($conn, $sql6) or die( mysqli_error($conn));
    $row6 = mysqli_fetch_array($result6);
        $male_R4B_ROM = $row6['male'];
        $female_R4B_ROM = $row6['female'];
    
    $sql7 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region IV-B' AND province = 'Palawan'";
    $result7 = mysqli_query($conn, $sql7) or die( mysqli_error($conn));
    $row7 = mysqli_fetch_array($result7);
        $male_R4B_PAL = $row7['male'];
        $female_R4B_PAL = $row7['female'];

    $sql8 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region V' AND province = 'Albay'";
    $result8 = mysqli_query($conn, $sql8) or die( mysqli_error($conn));
    $row8 = mysqli_fetch_array($result8);
        $male_R5_ALB = $row8['male'];
        $female_R5_ALB = $row8['female'];
    
    $sql9 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region V' AND province = 'Camarines Norte'";
    $result9 = mysqli_query($conn, $sql9) or die( mysqli_error($conn));
    $row9 = mysqli_fetch_array($result9);
        $male_R5_CAM_NOR = $row9['male'];
        $female_R5_CAM_NOR = $row9['female'];
    
    $sql10 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region V' AND province = 'Camarines Sur'";
    $result10 = mysqli_query($conn, $sql10) or die( mysqli_error($conn));
    $row10 = mysqli_fetch_array($result10);
        $male_R5_CAM_SUR = $row10['male'];
        $female_R5_CAM_SUR = $row10['female'];

    $sql11 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region V' AND province = 'Catanduanes'";
    $result11 = mysqli_query($conn, $sql11) or die( mysqli_error($conn));
    $row11 = mysqli_fetch_array($result11);
        $male_R5_CAT = $row11['male'];
        $female_R5_CAT = $row11['female'];
    
    $sql12 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region V' AND province = 'Masbate'";
    $result12 = mysqli_query($conn, $sql12) or die( mysqli_error($conn));
    $row12 = mysqli_fetch_array($result12);
        $male_R5_MAS = $row12['male'];
        $female_R5_MAS = $row12['female'];

    $sql13 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region V' AND province = 'Sorsogon'";
    $result13 = mysqli_query($conn, $sql13) or die( mysqli_error($conn));
    $row13 = mysqli_fetch_array($result13);
        $male_R5_SOR = $row13['male'];
        $female_R5_SOR = $row13['female'];
    
    $sql14 = "SELECT * FROM acc_attendance WHERE acc_att_ID = '$id' AND region = 'Region V' AND province = 'Other Provinces'";
    $result14 = mysqli_query($conn, $sql14) or die( mysqli_error($conn));
    $row14 = mysqli_fetch_array($result14);
        $male_R5_OP = $row14['male'];
        $female_R5_OP = $row14['female'];
...
if(isset($_POST['btn-search'])){    //serach buttons function
    ...
    if($search != ''){
            ...
            $sql2 = "SELECT * FROM accomplishment WHERE id LIKE '%$search%' OR quarter LIKE '%$search%' OR project LIKE '%$search%' OR region LIKE '%$search%' OR province LIKE '%$search%'
                    ...
                    OR type LIKE '%$search%' OR conducted_By LIKE '%$search%' OR resourse_Person LIKE '%$search%'";
...
<html>
    <head>
    <link rel="stylesheet" href="accomplishment1.css" type="text/css">
    <title>Training Accomplishments</title>
    </head>
    <body>
        <main>
            ...
            <section>
                    ...
                    <div class="panel-body mt-5" style="overflow-x:auto;"> 
                                ...
                                <form action = "accPrint.php" method = "post" class = "form-control" >
                                    <div class="row" style ="width:70%; margin:auto; margin-top: 10px;">
                                        <div class="col">
                                            <label for="region" class="form-label">Select Region</label>
                                                    ...
                                                    ?> 
                                                    <select name="region1" id="region1" class="form-control action">
                                        ...
                                        <div class="col">
                                            <label for="province" class="form-label">Select Province</label>
                                                    <select name="province1" id="province1" class="form-control action">
                            ...
                            <table class="table table-bordered"> 
                                ...
                                */ ?>  
                                                ...
                                                <td style="text-align:center">
                                                    <a href="accomplishment.php?edit=<?php echo $row["id"]; ?>" class="edit_btn"><i class="fas fa-edit fa-lg"></i>
                                ...
                                <form action = "accomplishment.php" method = "post" class = "form-control searchBox" >
                ...
                <div class="container">
                    <form method="post" action="accomplishmentOp.php" enctype="multipart/form-data"> 
                        
                        <div class="row align-items-center mt-2">
                            <div class="btn-group mt-3" role="group" aria-label="Basic example">
                                <input type="button" class = "btn btn-warning" id="secondaryButton" onclick="document.getElementById('btn-update').click()" value = "UPDATE">
                                <input type="button" class = "btn btn-danger" id="thirdButton" onclick="document.getElementById('btn-delete').click()" value = "DELETE"> 
                            </div>
                        </div>                
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-8 col-lg-8 col-xl-10">
                                ...
                                <div class="row align-items-center mt-2" style ="width:100%; margin:auto;">
                                    <a class="btn btn-success" data-bs-toggle="collapse" href="#multiCollapseExample2" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Region IV-B Attendance</a>
                                </div>
                                ...
                                <div class="row align-items-center mt-2" style ="width:100%; margin:auto;">
                                    <a class="btn btn-success" data-bs-toggle="collapse" href="#multiCollapseExample3" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Region V Attendance</a>
                                </div>
                                ...
                                <div class="dropdown row justify-content-center mt-2" style ="width:100%; margin:auto;">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/19ybUwp7mga0ZcyCyqg-tpdRrfxXO2S2m?usp=sharing">Administrative and Finance</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1HrP5Q12j_eIMjHoWxFERfjCAGgJBvKI7?usp=sharing">CyberSecurity</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1x6D0wCTVqRnzc3qILCUOy2tIwLR96eJd?usp=sharing">DICT LC3 Event Pictures/Videos</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1Q1-QlipbY-51_oDnoz2NUqb4D-rskQPJ?usp=sharing">DJPH</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1YFrY3e0U3IUUXNjOBJG9tPitjNLY3lPk?usp=sharing">DRRM</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1iPJQACFFwRP_Uy4GpvSzVHE3qC16_6pu?usp=sharing">eBPLS</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1OtHgmdoCngPLYFbdbN5iF50FJ-aYsYUB?usp=sharing">Free Wi-Fi for All</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1T05Q0gBdMKet7kXgDqpKEKL_TiZrdK6T?usp=sharing">GAD</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1roepIUko1_SZmZ7NAfkNQwQKfrDd01Rs?usp=sharing">GOSD</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1-4oDWZsNWLgOwNot6LWOlO8gTCxsrwqR?usp=sharing">GOVNET</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1pvzHhhjUsh4bc3WZSKWy9RWvbCaYGI19?usp=sharing">GVCS</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1qLw5K7O2e36od3TFY1wC97XCN8yS81n9?usp=sharing">IIDB</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1Kg7n4zhcLpgdvoB__PekKMMXWB5th159?usp=sharing">ILCDB</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1hKch_JBupUhSSqF187_3cdxabUwM7GNH?usp=sharing">Information Division</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1aekJorMiFRunBmPtqA0kwHhYGJfJ_dOj?usp=sharing">MISS</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1T0LsY1bEV6ZWKT0MZAxLeFYUrl1H96XD?usp=sharing">PNPKI</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/117uwEg1WrzUMWPBgt_hj8-H-ZppIRjch?usp=sharing">Senior Citizens and PWDs</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1N_63gzBLyBJJTg1Ce5sGMyKripk8ZujU?usp=sharing">Tech4ED</a></li>
                                                <li><a class="dropdown-item" target="_blank" href="https://drive.google.com/drive/folders/1kPfvg5CdJtxSn1qf2VYyBtpdL5nY9neg?usp=sharing">VIMS-IR/VAS</a></li>
                                            </ul>
